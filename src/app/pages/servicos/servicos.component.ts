  ...
  services = [
    {
      ...
      icon: 'fas fa-bolt',
      imageUrl: '/assets/fotos/webp/laser-servico.webp',
      features: [
    ...
    },
    {
      ...
      imageUrl: '/assets/fotos/webp/dobra-servico.webp',
      features: [
    ...
    },
    {
      ...
      icon: 'fas fa-cog',
      imageUrl: '/assets/fotos/webp/serra-servico.webp',
      features: [
    ...
    },
    {
      ...
      icon: 'fas fa-cubes',
      imageUrl: '/assets/fotos/webp/inox-servico.webp',
      features: [
